...
def generate_response(message_history):
    ...
    response = client.chat.completions.create(
        ...
        temperature=0,  # The temperature can range from 0 to 2.
        max_tokens=100,  # limite de palabras de respuesta
        top_p=0.5,  # decirle al gpt que use las "palabras" con probabilidades altas, el resto las ignora
