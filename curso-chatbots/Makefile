...
#de los comandos iniciales solo debia crear uv-cache en el disco D q si tenia espacio y luego crear una variable de entorno que apunte esa carpeta
#y ya hacer make install
# install:
...
#lo ejecute desde el cmd no de vscode. cree una variable de entorno que apunte a uv-cache y luego active el entorno .venv\Scripts\activate dentro de
# directorio del proyecto y ahi ejecute uv pip install torch torchvision torchaudio --index-url https://download.pytorch.org/whl/cu121
